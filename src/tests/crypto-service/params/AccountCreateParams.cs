...
{
    public class AccountCreateParams : Parameters
    {
        public AccountCreateParams(Dictionary<string, object> parameters) : base(parameters)
        {
            ...
            Alias = parameters["alias"] as string;
