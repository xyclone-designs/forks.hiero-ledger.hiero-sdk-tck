...
namespace Hedera.Hashgraph.Tests.SDK.Keys
{
    public class ECDSAPublicKeyTest
    {
        ...
        public virtual void KeyByteValidation()
        {
            ...
            Assert.Throws<ArgumentException>(() => PublicKey.FromBytesECDSA(invalidCompressedKey));
            ...
            Assert.Throws<ArgumentException>(() => PublicKey.FromBytesECDSA(malformedKey));
            ...
            _ = PublicKey.FromBytesECDSA(validCompressedKey);
            byte[] validDERKey = PrivateKey.GenerateECDSA().GetPublicKey().ToBytesDER();
            _ = PublicKey.FromBytesECDSA(validDERKey);
        }
        [Fact]
        ...
        public virtual void KeyByteSerializationThroughTransaction()
        {
            ...
            _ = Transaction.FromBytes<TransferTransaction>(bytes);
        ...
        [Fact]
        public virtual void ToEvmAddress()
        {
